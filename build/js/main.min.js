...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/swiper":13,"./modules/tabs/init-tabs":14,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var initSwiper = function initSwiper() {
  var swiperTrainers = new Swiper('.trainers__item', {
    navigation: {
      nextEl: '.trainers__swiper-btn-next',
      prevEl: '.trainers__swiper-btn-prev'
    }
  });
  var swiperComment = new Swiper('.comment__item', {
    navigation: {
